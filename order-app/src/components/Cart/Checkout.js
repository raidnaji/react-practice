...
const Checkout = (props) => {
  ...
  const confirmHandler = (event) => {
    ...
    const enteredPostalName = postalInputRef.current.value;
    const enteredCityName = cityInputRef.current.value;

    const enteredNameIsValid = !isEmpty(enteredName);
    const enteredStreetIsValid = !isEmpty(enteredStreetName);
    const enteredPostalIsValid = isFiveChars(enteredPostalName);
  ...
  return (
    <form className={classes.form} onSubmit={confirmHandler}>
      ...
      <div className={postalControlClasses}>
        ...
        {!formInputsValidity.postal && <p>Please enter a valid postal! 5 charachters</p>}
      </div>
